...
title: Columbarium V
drafts: |-
  "Columbarium IV"에 이어서 그때 썼던 비둘기 형태를 그대로 재활용해서 새롭게 추가된 무덤 6구를 다시 바닥에 두고, 비둘기 형상의 머리 앞쪽을 중심에 두고 306도로 원을 그렸다.
  나는 이 둥그렇게 모여진 6개의 무덤은 상단에서 바라봤을때 그것이 꽃처럼 피어오르는 형상처럼 보이기도하고 분수대 혹은 코린트식 기둥의 무늬장식 같기도 보였으면 했다.
