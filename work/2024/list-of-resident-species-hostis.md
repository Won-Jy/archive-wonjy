...
<style>
  ...
  /* Force the first column (#) to be center-aligned */
...
<div class="intro-media">
  ...
  <figcaption class="caption">White goosefoot — <i>Chenopodium album</i></figcaption>
      ...
      <tr>
        <td>2</td>
        <td>Fausse roquette</td>
        <td>White wall-rocket</td>
        <td><i>Diplotaxis erucoides</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_02.webp" alt="White wall-rocket — Diplotaxis erucoides" loading="lazy" decoding="async">
  <figcaption class="caption">White wall-rocket — <i>Diplotaxis erucoides</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>3</td>
  ...
  <figcaption class="caption">Dwarf elder — <i>Sambucus ebulus</i></figcaption>
      ...
      <tr>
        <td>4</td>
        <td>Vergerette de Sumatra</td>
        <td>Sumatran fleabane</td>
        <td><i>Sambucus ebulus</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_04.webp" alt="Sumatran fleabane — Sambucus ebulus" loading="lazy" decoding="async">
  <figcaption class="caption">Sumatran fleabane — <i>Sambucus ebulus</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>5</td>
  ...
  <figcaption class="caption">Sweet wormwood — <i>Artemisia annua</i></figcaption>
      ...
      <tr>
        <td>7</td>
        <td>Inule visqueuse</td>
        <td>Sticky fleabane</td>
        <td><i>Dittrichia viscosa</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_07.webp" alt="Sticky fleabane — Dittrichia viscosa" loading="lazy" decoding="async">
  <figcaption class="caption">Sticky fleabane — <i>Dittrichia viscosa</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>8</td>
  ...
  <figcaption class="caption">Slender sow-thistle — <i>Sonchus tenerrimus</i></figcaption>
      ...
      <tr>
        ...
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_09.webp" alt="Ribwort plantain — Plantago lanceolata" loading="lazy" decoding="async">
  <figcaption class="caption">Ribwort plantain — <i>Plantago lanceolata</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>10</td>
        <td>Oseille crépue</td>
        <td>Curly dock</td>
        <td><i>Rumex crispus</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_10.webp" alt="Curly dock — Rumex crispus" loading="lazy" decoding="async">
  <figcaption class="caption">Curly dock — <i>Rumex crispus</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>11</td>
  ...
  <figcaption class="caption">Common sorghum — <i>Sorghum bicolor</i></figcaption>
      ...
      <tr>
        <td>13</td>
        <td>Amarante réfléchie</td>
        <td>Redroot pigweed</td>
        <td><i>Amaranthus retroflexus</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_13.webp" alt="Redroot pigweed — Amaranthus retroflexus" loading="lazy" decoding="async">
  <figcaption class="caption">Redroot pigweed — <i>Amaranthus retroflexus</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>14</td>
  ...
  <figcaption class="caption">Princess tree — <i>Paulownia tomentosa</i></figcaption>
      ...
      <tr>
        <td>15</td>
        <td>Ailante glanduleux</td>
        <td>Tree of heaven</td>
        <td><i>Ailanthus altissima</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_15.webp" alt="Tree of heaven — Ailanthus altissima" loading="lazy" decoding="async">
  <figcaption class="caption">Tree of heaven — <i>Ailanthus altissima</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>16</td>
  ...
  <figcaption class="caption">Fennel — <i>Foeniculum vulgare</i></figcaption>
      ...
      <tr>
        <td>18</td>
        <td>Cyprès toujours vert</td>
        <td>Italian cypress</td>
        <td><i>Cupressus sempervirens</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_18.webp" alt="Italian cypress — Cupressus sempervirens" loading="lazy" decoding="async">
  <figcaption class="caption">Italian cypress — <i>Cupressus sempervirens</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>19</td>
  ...
  <figcaption class="caption">Red elder — <i>Sambucus racemosa</i></figcaption>
      ...
      <tr>
        ...
        <td>Sorgho d’Alep</td>
        <td>Johnson grass</td>
        <td><i>Sorghum halepense</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_20.webp" alt="Johnson grass — Sorghum halepense" loading="lazy" decoding="async">
  <figcaption class="caption">Johnson grass — <i>Sorghum halepense</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>21</td>
  ...
  <figcaption class="caption">Rosemary — <i>Salvia rosmarinus</i></figcaption>
      ...
      <tr>
        <td>26</td>
        <td>Séséli tortueux</td>
        <td>Twisted seseli</td>
        <td><i>Seseli tortuosum</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_26.webp" alt="Twisted seseli — Seseli tortuosum" loading="lazy" decoding="async">
  <figcaption class="caption">Twisted seseli — <i>Seseli tortuosum</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>27</td>
        <td>Stipe millet</td>
        <td>Millet grass</td>
        <td><i>Achnatherum miliaceum</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_27.webp" alt="Millet grass — Achnatherum miliaceum" loading="lazy" decoding="async">
  <figcaption class="caption">Millet grass — <i>Achnatherum miliaceum</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>28</td>
        <td>Barbon Andropogon</td>
        <td>Cane bluestem</td>
        <td><i>Bothriochloa barbinodis</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_28.webp" alt="Cane bluestem — Bothriochloa barbinodis" loading="lazy" decoding="async">
  <figcaption class="caption">Cane bluestem — <i>Bothriochloa barbinodis</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>29</td>
        <td>Cousteline</td>
        <td>Reichardia</td>
        <td><i>Reichardia picroides</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_29.webp" alt="Reichardia — Reichardia picroides" loading="lazy" decoding="async">
  <figcaption class="caption">Reichardia — <i>Reichardia picroides</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>30</td>
  ...
  <figcaption class="caption">Aphrodite moth orchid — <i>Phalaenopsis aphrodite</i></figcaption>
      ...
      <tr>
        <td>38</td>
        <td>Érodium à feuilles molles</td>
        <td>Soft stork's-bill</td>
        <td><i>Erodium malacoides</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_38.webp" alt="Soft stork's-bill — Erodium malacoides" loading="lazy" decoding="async">
  <figcaption class="caption">Soft stork's-bill — <i>Erodium malacoides</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>39</td>
        <td>Origan</td>
        <td>Oregano</td>
        <td><i>Origanum vulgare</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_plant_39.webp" alt="Oregano — Origanum vulgare" loading="lazy" decoding="async">
  <figcaption class="caption">Oregano — <i>Origanum vulgare</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>40</td>
...
<div class="intro-media">
  ...
  <figcaption class="caption">Bluebottle fly (suspected) — <i>Calliphora vicina (présumé)</i></figcaption>
      ...
      <tr>
        <td>10</td>
        <td>Moustique commun (présumé)</td>
        <td>Common house mosquito (suspected)</td>
        <td><i>Culex pipiens (présumé)</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_animal_10.webp" alt="Common house mosquito (suspected) — Culex pipiens (présumé)" loading="lazy" decoding="async">
  <figcaption class="caption">Common house mosquito (suspected) — <i>Culex pipiens (présumé)</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>11</td>
        <td>Idée orangée (nom non officiel) (présumé)</td>
        <td>Orange wave moth (tentative)</td>
        <td><i>Idaea degeneraria (présumé)</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_animal_11.webp" alt="Orange wave moth (tentative) — Idaea degeneraria (présumé)" loading="lazy" decoding="async">
  <figcaption class="caption">Orange wave moth (tentative) — <i>Idaea degeneraria (présumé)</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>12</td>
        <td>Gecko nocturne</td>
        <td>Mediterranean house gecko</td>
        <td><i>Hemidactylus turcicus</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_animal_12.webp" alt="Mediterranean house gecko — Hemidactylus turcicus" loading="lazy" decoding="async">
  <figcaption class="caption">Mediterranean house gecko — <i>Hemidactylus turcicus</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>13</td>
        <td>Blatte orientale (présumé)</td>
        <td>Oriental cockroach (suspected)</td>
        <td><i>Blatta orientalis (présumé)</i></td>
        <td class="spec-note"></td>
        <td class="img"><figure class="work thumb">
  <img class="work" src="/images/2024/list-of-resident-species-hostis/list_animal_13.webp" alt="Oriental cockroach (suspected) — Blatta orientalis (présumé)" loading="lazy" decoding="async">
  <figcaption class="caption">Oriental cockroach (suspected) — <i>Blatta orientalis (présumé)</i></figcaption>
</figure></td>
      </tr>
      <tr>
        <td>14</td>
